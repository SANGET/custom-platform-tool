...
//   const {
//     treeData, onExpand, expandedKeys, autoExpandParent
//   } = props;
//   // constructor(props) {
//   //   super(props);
...
//   //   this.state.autoExpandParent = autoExpandParent;
//   // }
...
//   //     }
//   //   };
//   //   const data = [...this.state.props.treeData];
...
//   //   });
//   // };
//   // console.log(this.state.props.treeData);
//   return (
//     <Tree
//       draggable
//       blockNode
...
export default class BasicTree extends React.Component {
  ...
  onChange = (e) => {
    ...
    const expandedKeys = loop(dataList);
    ...
    return (
      <div>
        ...
        <Tree
          ...
          expandedKeys={expandedKeys}
          autoExpandParent={autoExpandParent}
          treeData={loop(this.state.searchValue, this.state.treeData)}
        />
      </div>
    );
  }
