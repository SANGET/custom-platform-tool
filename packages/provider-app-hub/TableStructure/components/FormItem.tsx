...
import { Button, Form, Input, TreeSelect, Row, Col } from 'antd';
import { FormInstance } from 'antd/lib/form';
import { construct } from '@infra/utils/tools'
import pinyin4js from 'pinyin4js'
import { RE, MENUS_TYPE, TABLE_TYPE } from '../constant';
...
export const NameCodeItem: React.FC<IProps> = React.memo((props: IProps): ReactElement => {
  ...
  */
  ...
  return (
    <>
      <Form.Item name="name" label="数据表名称"
        rules={[
      ...
      <Form.Item name="code" label="数据表编码" rules={[
