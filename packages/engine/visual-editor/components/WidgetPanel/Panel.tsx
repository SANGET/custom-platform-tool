...
import { WidgetTypeMeta } from '@engine/visual-editor/data-structure';
...
export interface ComponentPanelProps {
  ...
  itemWrapper?: (item: WidgetTypeMeta) => React.ReactChild
  /** 控制 DragItemComp 的 drag 配置的 interface，详情参考 react-dnd */
  getDragItemConfig?: (item: WidgetTypeMeta) => DragItemConfig
